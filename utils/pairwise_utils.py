...
def save_performance_results(top1, top3, special_string):
    ...
    save_pickle(file=data, file_location='/home/ghost/PycharmProjects/bayesian_prolo/saved_models/pairwise_saved_models/', special_string=special_string)
