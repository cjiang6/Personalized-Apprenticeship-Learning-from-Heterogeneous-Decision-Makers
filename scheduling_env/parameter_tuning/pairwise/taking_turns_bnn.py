...
class BNNTrain:
    ...
    def train(self):
        ...
        while not training_done:
            ...
            rand_timestep_within_sched = np.random.randint(len(self.start_of_each_set_twenty)*.8)
    ...
    def evaluate_on_test_data(self, load_in_model=False):
        ...
        for j in range(int(.8*num_schedules), num_schedules):
            ...
            prediction_accuracy = [0, 0]
        self.save_performance_results(percentage_accuracy_top1, percentage_accuracy_top3, 'turns_bnn_small_' + str(self.num_schedules))
