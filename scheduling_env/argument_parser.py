...
def parse_args():
    ...
    parser.add_argument('--alpha', type=float, default=0.5, help='alpha div parameter')
    ...
    parser.add_argument("--home-dir", type=str, default="/home/ghost/PycharmProjects/bayesian_prolo")
