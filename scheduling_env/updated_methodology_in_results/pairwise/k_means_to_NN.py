...
class NNTrain:
    ...
    def evaluate_on_test_data(self, models, schedules_trained_on, load_in_model=False):
        ...
        for j in range(0, num_schedules):
            ...
            while step < schedule_bounds[1]:
                ...
                for m, counter in enumerate(range(step, step + 20)):
                    ...
                    for n, second_counter in enumerate(range(step, step + 20)):
                        ...
                        preference_prob = self.models[int(cluster_num)].forward(feature_input)
            ...
            prediction_accuracy = [0, 0]
        save_performance_results(percentage_accuracy_top1, percentage_accuracy_top3, 'pairwise_NN_kmeans.pkl')
