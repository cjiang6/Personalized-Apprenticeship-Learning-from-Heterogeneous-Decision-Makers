...
class NNTrain:
    ...
    def __init__(self, num_schedules):
        ...
        self.opt = torch.optim.SGD(self.model.parameters(), lr=.001) # TODO: tune weight decay
    ...
    def evaluate_on_test_data(model, schedules_trained_on, load_in_model=False):
        ...
        for j in range(0, num_schedules):
            ...
            prediction_accuracy = [0, 0]
        save_performance_results(percentage_accuracy_top1, percentage_accuracy_top3, 'NN_pairwise.pkl')
