...
class NNTrain:
    ...
    def __init__(self):
        ...
        self.opt = torch.optim.Adam(self.model.parameters()) # TODO: tune weight decay
    ...
    def evaluate_on_test_data(model, schedules_trained_on, load_in_model=False):
        ...
        for j in range(0, num_schedules):
            ...
            prediction_accuracy = [0, 0]
        save_performance_results(percentage_accuracy_top1, percentage_accuracy_top3, 'pointwise_NN.pkl')
...
def main():
    ...
    trainer = NNTrain()
    trainer.train()
    per_schedule_test_accs = trainer.evaluate_on_test_data(trainer.model, num_schedules)
