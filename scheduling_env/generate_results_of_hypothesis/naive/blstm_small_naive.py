"""
training and evaluating an blstm with the same number of parameters as a BDDT
"""
...
class BLSTMTrain:
    ...
    def __init__(self, num_schedules):
        ...
        del blstm_params[12]
        self.opt = torch.optim.Adam(blstm_params, lr=.0001)  # TODO: try together and not together
