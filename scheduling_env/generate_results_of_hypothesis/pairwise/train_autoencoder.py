...
class AutoEncoderTrain:
        ...
        while not training_done:
            ...
            if total_iterations % 1000 == 999:
                ...
                torch.save({'nn_state_dict': self.model.state_dict()},
                           '/home/ghost/PycharmProjects/bayesian_prolo/saved_models/Autoencoder' + str(self.num_schedules) + '.tar')
    ...
    def save_matrixes(self):
        ...
        :return:
        """
        save_pickle('/home/ghost/PycharmProjects/bayesian_prolo/scheduling_env/', self.matrixes, str(self.num_schedules) + 'matrixes.pkl')
